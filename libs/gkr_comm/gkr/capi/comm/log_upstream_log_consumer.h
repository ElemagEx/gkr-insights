...
struct gkr_comm_upstream_log_consumer_callbacks
{
...
GKR_CLIENT_COMM_API int gkr_comm_add_upstream_log_consumer(
    void* channel,
    void* param,
...
GKR_CLIENT_COMM_API int gkr_comm_add_upstream_log_consumer_ex(
    void* channel,
    void* param,
    const struct gkr_comm_upstream_log_consumer_callbacks* callbacks,
    const char* url,
