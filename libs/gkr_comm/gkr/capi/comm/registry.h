...
GKR_CLIENT_COMM_API struct gkr_comm_provider* gkr_comm_client_register_provider(const char* name);
GKR_SERVER_COMM_API struct gkr_comm_provider* gkr_comm_server_register_provider(const char* name);
