...
GKR_COMM_PIPES_API    struct gkr_comm_provider* gkr_comm_register_client_provider(const char* name);
GKR_COMM_SERVICES_API struct gkr_comm_provider* gkr_comm_register_server_provider(const char* name);
